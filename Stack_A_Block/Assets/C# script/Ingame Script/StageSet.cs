...
public class StageSet : MonoBehaviour
{
    ...
    {   
        ...
        for(int i = 0;i<24;i++){
            if(userdatamanager.Stage1[i] == 0){
                stages[i+1].GetComponent<Image>().color = new Color32(125,125,125,255);
            }else if(userdatamanager.Stage1[i] <= 30){
                star[i].GetComponent<Image>().sprite = starlists[0];
                stages[i+1].GetComponent<Image>().color = new Color32(255,255,255,255);
            }else if(userdatamanager.Stage1[i] <= 60 && userdatamanager.Stage1[i] > 30){
                star[i].GetComponent<Image>().sprite = starlists[1]; 
                stages[i+1].GetComponent<Image>().color = new Color32(255,255,255,255);
            }else if(userdatamanager.Stage1[i] <= 90 && userdatamanager.Stage1[i] > 60){
                star[i].GetComponent<Image>().sprite = starlists[3];  
                stages[i+1].GetComponent<Image>().color = new Color32(255,255,255,255);
            }
        }
            if(userdatamanager.Stage1[24] == 0){
            }
            else if(userdatamanager.Stage1[24] <= 30){
                star[24].GetComponent<Image>().sprite = starlists[0];
            }else if(userdatamanager.Stage1[24] <= 60 && userdatamanager.Stage1[24] > 30){
                star[24].GetComponent<Image>().sprite = starlists[1];
            }else if(userdatamanager.Stage1[24] <= 90 && userdatamanager.Stage1[24] > 60){
